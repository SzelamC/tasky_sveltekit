...
<FormBox title="Sign up" on:submit={register}>
	...
	<a href="/accounts/login" class="inline-flex max-w-fit rounded-btn items-center text-sm">
		<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 512" class="w-4 h-4 fill-current"
			><path
